...
// be found at  "code.cloudfoundry.org/cli/plugin/basicplugin.go"
...
func (c *BasicPlugin) Run(cliConnection plugin.CliConnection, args []string) {
	...
	if args[0] == "basic-plugin-command" {
		...
		output, err := cliConnection.CliCommandWithoutTerminalOutput("curl", "/v2/info")
		if err != nil {
			fmt.Printf("Error: %s\n", err.Error())
			return
		}

		fmt.Println("=== Return from curl /v2/info follows ===")
		fmt.Println(output)
		fmt.Println("=========================================")
	}
}
...
func main() {
	...
	// implementing the interface defined at "code.cloudfoundry.org/cli/plugin/basicplugin.go"
	//
